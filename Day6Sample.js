...
let b1 = parseInt(prompt("Second number?"));
let TotalValue = a1 + b1; 
alert(` The sum of two number is ${a1} and ${b1} is ${TotalValue} `);
...
// Part1: Q8
let a3 = prompt("Enter a number for Question 8?");
...
//Part1: Q9
let value9 = prompt('How many runs you scored in this ball');
if (value9 == 4) {
      console.log("You hit a Four");
} else if (value9 == 6) {
      console.log("You hit a Six");
} else {
      console.log(`I couldn't figure out : You hit a ${value9}`);
}

Part1: Q10
let login10 = prompt('Employee/Director');
let message10 = (login10 == 'Employee') ? 'Greetings : Welcome ' : (login10 == 'Director') ? 'Greetings : Welcome ' : (login10 == '') ? 'No login' : '';
console.log(`${message} ${login10} `);
...
// Part1: Q12
let message12 = "Welcome Boss";
let lock12 = false;
//Dont change any code below this 
if (null || lock12 || undefined )
{
  message12 = "Go away";
}
else
...
let NumOflines15 = 4;
let MaxNum15 = 10;
for ( let ix = 0; ix < NumOflines15; ix++) {
 var  new_stringx15 ="";
    for ( let jx = 1; jx <= MaxNum15; jx++) {
    new_stringx15 +=  jx;
    }
    console.log(new_stringx15);
}
// Part1: Q16
